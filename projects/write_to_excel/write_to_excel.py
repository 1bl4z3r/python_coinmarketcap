...
crypto_sheet.write('C1', 'Market Cap USD')
crypto_sheet.write('D1', 'Price USD')
crypto_sheet.write('E1', '24H Volume USD')
crypto_sheet.write('F1', 'Hour Change USD')
crypto_sheet.write('G1', 'Day Change USD')
crypto_sheet.write('H1', 'Week Change USD')
